...
export default async function CampoEditarRdoPage({ params }: { params: Promise<{ id: string; rdoId: string }> }) {
  ...
  const updateRdoWithId = updateRdo.bind(null, "/campo/obras", rdo.id);

  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-xl font-semibold tracking-tight">Editar RDO #{rdo.numero}</h1>
      <RdoForm
