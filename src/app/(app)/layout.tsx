  ...
  return (
    <div className="flex h-svh flex-col overflow-hidden md:flex-row">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        <header className="z-40 flex h-14 shrink-0 items-center justify-between border-b bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/80">
